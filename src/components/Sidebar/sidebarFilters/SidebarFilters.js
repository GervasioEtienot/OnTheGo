...
import SidebarFiltroAccesorios from './SidebarFiltroAccesorios';
import SidebarFiltrosGenerales from './SidebarFiltrosGenerales';
...
class SidebarFilters extends Component {
   ...
   agreeToFilter(aFiltrar, tipo, borrarModelsToFilter){
    ...
    //   console.log(arrayDeFiltros);
      ...
      this.props.searchProduct(arrayDeFiltros);
      ...
      return (
         <div>
            <div className="cleanFilters">
               <Button color="secondary" outline size="sm" block onClick={() => this.setState({ cleanFilters: true }) }>
                  Limpiar filtros
               </Button>
            </div>
            {categoria === 'accessories' ? <SidebarFiltroAccesorios 
            ...
            {categoria !== 'accessories' ? <SidebarFiltrosGenerales 
                                                   filtros={this.state.filtrosRecibidos}
                                                   loading={loading}
                                                   checkFilters={this.checkFilters}
                                                   onAgreeToFilter={this.agreeToFilter.bind(this)}
