module.exports = {
   "sidebar.accessories": "Accesorios",
   "sidebar.parts": "Partes",
   "sidebar.batteries": "Baterías",
   "sidebar.lensun": "Lensun",
   "sidebar.offers": "Promos",
   "sidebar.sales": "Liquidación",
   "sidebar.app": "Inicio",
   ...
   "components.CartEmptyText": "¡Su carro está vacío!",
   ...
   "components.id": "ID",
   "components.dateOfPurchase": "Fecha de compra",
   "components.status": "Estado",
   "components.cartPrice": "Precio Carrito", 
   "sidebar.saas": "SAAS",
